...
The average age of the sample is `r round(mean(WL1$Age)/12, digits = 2)` months.

The standard deviation age of the sample is `r round(sd(WL1$Age)/12, digits = 2)` months.

The minimum age of the sample is `r round(min(WL1$Age)/12, digits = 2)` months.

The maximum age of the sample is `r round(max(WL1$Age)/12, digits = 2)` months.
...
There are now `r num_subs` participants.
...
```{r Figure_4_left, fig.height=8,fig.width=8}
...
The average age of the sample is `r round(mean(WL2$Age)/12, digits = 2)` months.

The standard devation of the age of the sample is `r round(sd(WL2$Age/12), digits = 2)` months.

The minimum age of the sample is `r round(min(WL2$Age)/12, digits = 2)` months.

The maximum age of the sample is `r round(max(WL2$Age)/12, digits = 2)` months.
...
The standard devaition of the age of the sample is `r round(sd(WL2$Age/12), digits = 2)` months.
...
##Results
###Comparisons with chance for three test questions.
```{r Figure_4_right, fig.height=8,fig.width=8}
#Compare performance to chance guessing
