...
WL$EJ.Purple = (ifelse(WL$EJ1!="Purple",1,0) + ifelse(WL$EJ2!="Purple",1,0))/2
WL$EJ.Orange = (ifelse(WL$EJ1!="Orange",1,0) + ifelse(WL$EJ2!="Orange",1,0))/2
...
WL$Ask.Match = (ifelse(WL$Ask1B==WL$AccurateRobot,1,0) + ifelse(WL$Ask2B==WL$AccurateRobot,1,0) 
                + ifelse(WL$Ask3B==WL$AccurateRobot,1,0) + ifelse(WL$Ask4B==WL$AccurateRobot,1,0))/4

WL$Ask.Purple = (ifelse(WL$Ask1B=="Purple",1,0) + ifelse(WL$Ask2B=="Purple",1,0) 
                 + ifelse(WL$Ask3B=="Purple",1,0) + ifelse(WL$Ask4B=="Purple",1,0))/4
WL$Ask.Orange = (ifelse(WL$Ask1B=="Orange",1,0) + ifelse(WL$Ask2B=="Orange",1,0) 
                 + ifelse(WL$Ask3B=="Orange",1,0) + ifelse(WL$Ask4B=="Orange",1,0))/4
...
WL$Word.Match = (ifelse(WL$Ask1C==WL$AccurateRobot,1,0) + ifelse(WL$Ask2C==WL$AccurateRobot,1,0) 
                 + ifelse(WL$Ask3C==WL$AccurateRobot,1,0) + ifelse(WL$Ask4C==WL$AccurateRobot,1,0))/4

WL$Word.Purple = (ifelse(WL$Ask1C=="Purple",1,0) + ifelse(WL$Ask2C=="Purple",1,0) 
                 + ifelse(WL$Ask3C=="Purple",1,0) + ifelse(WL$Ask4C=="Purple",1,0))/4
WL$Word.Orange = (ifelse(WL$Ask1C=="Orange",1,0) + ifelse(WL$Ask2C=="Orange",1,0) 
                 + ifelse(WL$Ask3C=="Orange",1,0) + ifelse(WL$Ask4C=="Orange",1,0))/4
